...
Generated classes remain reusable while live, without the class cache itself retaining discarded defining loaders. A replacement loader can compile a new version. Custom file-manager retention is a separate lifetime concern; no collection deadline is guaranteed.
