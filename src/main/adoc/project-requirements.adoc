...
JRC-NF-S-027 :: AI-assisted compilation pipelines *MUST* enforce the layered validation described in link:ai-runtime-guardrails.adoc#JRC-NF-S-027[AI Runtime Guardrails].
...
JRC-NF-O-028 :: AI-driven workloads *MUST* publish the telemetry set captured in link:ai-runtime-guardrails.adoc#JRC-NF-O-028[AI Runtime Guardrails].
...
JRC-DOC-030 :: The AI prompt-to-deployment workflow *MUST* be documented per link:ai-runtime-guardrails.adoc#JRC-DOC-030[AI Runtime Guardrails].
