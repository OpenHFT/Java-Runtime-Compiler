...
* _Decision:_ link:decision-log.adoc#RC-FN-002[RC-FN-002] (cached compiler API) and link:decision-log.adoc#RC-RISK-026[RC-RISK-026] (debug artefact safety).
...
* _Decision:_ link:decision-log.adoc#RC-NF-P-006[RC-NF-P-006] (performance and metaspace budget).
...
* _Decision:_ link:decision-log.adoc#RC-TEST-002[RC-TEST-002] (coverage gate alignment).
